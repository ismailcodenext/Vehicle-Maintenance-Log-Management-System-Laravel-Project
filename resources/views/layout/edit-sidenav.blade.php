...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="{{url('/doctorpage')}}" class="side-bar-item">
        <i class="bi bi-people"></i>
        <span class="side-bar-item-caption">Doctor</span>
    </a>

    <a href="{{url("/testCategoryPage")}}" class="side-bar-item">
        <i class="bi bi-list-nested"></i>
        <span class="side-bar-item-caption">Test Category</span>
    </a>

    <a href="{{url("/testPage")}}" class="side-bar-item">
        <i class="bi bi-bag"></i>
        <span class="side-bar-item-caption">Test Add</span>
    </a>

    <a href="{{url('/patientsPage')}}" class="side-bar-item">
        <i class="bi bi-currency-dollar"></i>
        <span class="side-bar-item-caption">Patient</span>
    </a>
