    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-10 center-screen">
                <div class="card animated fadeIn p-3 login_card login_cards" style="background: #fff">
                    <div class="card-body" style="padding: 0">
                        ...
                        <h2 style="text-align: center; font-size: 25px;color: white;">Sign Up</h2>
                        <div class="container-fluid m-0 p-0">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center mt-3">
                                    ...
                                    <div class="from_input">
                                        <label class="form-label form_labels">Image</label>
                            ...
                            <div class="row m-0 p-0">
                                <div class="col-12 mx-auto text-center p-2 card_body_wrapper">
                                    <button style="width: 100%;"  onclick="onRegistration()" class="btn mt-3 mx-auto text-center update_btn">Sign Up</button>
                                </div>
                            </div>

                            <div class="float-end mt-3">
                        <span class="sign_from">
                            <a class="text-center ms-3 text-light" href="{{url('/')}}" style="font-size: 16px;">Sign In </a>
                            <span class="ms-1 text-light">|</span>
                            <a class="text-center ms-1 text-light" href="{{url('/sendOtp')}}" style="font-size: 16px;">Forget Password</a>
                        </span>
                            </div>
                        </div>
                    </div>
