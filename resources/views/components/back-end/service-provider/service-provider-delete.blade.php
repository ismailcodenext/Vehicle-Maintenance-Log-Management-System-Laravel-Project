    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-end">
                <div>
                    <button type="button" id="delete-modal-close" style="color: #000;" class="btn mx-2 "
                        style="background: #016a70; color: #fff;" data-bs-dismiss="modal">Cancel</button>
                    <button onclick="itemDelete()" type="button" style="color: #000;" id="confirmDelete"
...
<script>
    async function itemDelete() {
        ...
        try {
            ...
            showLoader();
            let res = await axios.post("/delete-service-provider", {
                id: id
            }, HeaderToken())
            hideLoader();
